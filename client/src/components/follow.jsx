...
import { Row, Col , Button } from 'reactstrap';
        ...
        import { get_sign_up_data, get_.iii_sketch_‘3‘_data }  from '../actions/followActions.js'; 
...
{render_get_.iii_sketch_‘3‘_data()}
    ...
    function mapStateToProps(state) {
        ...
        function mapDispatchToProps(dispatch) {
            return bindActionCreators({ follow_action, follow_action get_sign_up_data, get_.iii_sketch_‘3‘_data }, dispatch);
        }
